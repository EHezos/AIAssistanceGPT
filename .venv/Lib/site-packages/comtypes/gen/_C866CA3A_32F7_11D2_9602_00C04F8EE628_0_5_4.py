...
__all__ = [
    ...
    'SRTSMLTimeout', 'SPLOADOPTIONS', 'ISpeechAudio',
    'DISPID_SVSpeakStream', 'SpeechRuleState', 'SRADynamic',
    'ISpeechMemoryStream', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPVPRI_NORMAL', 'SPEI_FALSE_RECOGNITION', 'DISPID_SVEPhoneme',
    ...
    'SAFTCCITT_ALaw_22kHzMono', 'ISpeechGrammarRules', 'SVP_3',
    'SPAUDIOSTATUS', 'SpeechAudioFormatGUIDWave',
    'DISPID_SpeechRecoContext',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SASCurrentDevicePosition', 'SPGS_EXCLUSIVE', 'SDTAudio',
    'SDA_Two_Trailing_Spaces', 'SSFMOpenReadWrite', 'SPEI_RESERVED2',
    'STCInprocServer', 'SAFTDefault', 'eLEXTYPE_PRIVATE3',
    'DISPID_SPIAudioSizeTime', 'SPSEMANTICFORMAT',
    'SpeechCategoryRecoProfiles', 'DISPID_SPRuleName', 'DISPID_SPPId',
    'SpeechRegistryLocalMachineRoot', 'ISpeechPhraseAlternate',
    'DISPID_SAFType', 'SPPS_Interjection', 'SAFT48kHz8BitMono',
    'ISpNotifyTranslator', 'SPEI_REQUEST_UI',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPPsCount',
    'DISPID_SRCERecognitionForOtherContext', 'SVEAllEvents', 'SVP_12',
    'SPPHRASEPROPERTY', 'SWTDeleted', 'ISpStreamFormatConverter',
    'SVP_11', 'DISPIDSPTSI_SelectionOffset', 'ISpeechRecoContext',
    'SPEI_MIN_TTS', 'DISPID_SRCRequestedUIType',
    'DISPID_SRGDictationLoad', '__MIDL_IWinTypes_0009',
    'SPWORDPRONOUNCEABLE', 'DISPID_SPIReplacements',
    'SSSPTRelativeToCurrentPosition', 'SPAS_CLOSED',
    'DISPID_SLWsCount', 'SP_VISEME_19', 'SVP_18', 'DISPID_SGRSTType',
    ...
    'SPEI_SR_AUDIO_LEVEL', 'SVP_10', 'IEnumString',
    'SAFT44kHz16BitMono', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SRCAudioInInterferenceStatus', 'SPSEMANTICERRORINFO',
    'SSFMCreateForWrite', 'SVP_7', 'DISPID_SRRGetXMLResult',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SpeechAudioStatus',
    'ISpeechAudioStatus', 'SPSModifier', 'SpeechRegistryUserRoot',
    'SRAImport', 'eLEXTYPE_PRIVATE15', 'DISPID_SPEDisplayAttributes',
    'SSSPTRelativeToEnd', 'SPAR_Medium', 'DISPID_SVSLastResult',
    'DISPID_SpeechPhraseProperties', 'DISPID_SABIMinNotification',
    'SAFT12kHz16BitStereo', 'DISPID_SpeechVoiceEvent',
    'SPEI_RESERVED5', 'DISPID_SVVoice', 'DISPID_SPCIdToPhone',
    'eLEXTYPE_PRIVATE19', 'SRTStandard', 'SSSPTRelativeToStart',
    'SECFIgnoreCase', 'SREBookmark', 'SpeechTokenKeyFiles', 'SPRULE',
    'ISpObjectTokenCategory', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRCEStartStream', 'DISPID_SPPName', 'SVPAlert',
    'SSTTTextBuffer', 'SECHighConfidence',
    'SpeechCategoryAppLexicons', 'SPAR_Low', 'DISPID_SVSpeak',
    'DISPID_SABufferInfo', 'SPEI_VOICE_CHANGE', 'eLEXTYPE_PRIVATE14',
    'SPEI_MAX_TTS', 'DISPID_SpeechPhraseElements',
    'DISPID_SLWs_NewEnum', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SPRs_NewEnum', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRGetPropertyString', 'SDA_Consume_Leading_Spaces',
    'SpeechStreamFileMode', 'SpeechGrammarWordType', 'SPVISEMES',
    'DISPID_SVStatus', 'SPEI_SR_BOOKMARK', 'SpeechTokenContext',
    'DISPID_SGRAttributes', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechObjectTokenCategory', 'SAFTExtendedAudioFormat',
    'SPRST_INACTIVE', 'DISPID_SRState', 'SPPS_RESERVED2',
    'SpeechSpecialTransitionType', 'DISPID_SRDisplayUI',
    'Speech_StreamPos_RealTime', 'DISPID_SVSPhonemeId', 'SVSFNLPMask',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SMSSetData',
    'DISPID_SLGenerationId', 'SPEI_MAX_SR', 'SpObjectTokenCategory',
    'DISPID_SRRTStreamTime', 'SRCS_Disabled', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechPhraseReplacement', 'SpPhoneticAlphabetConverter',
    'SDA_No_Trailing_Space', 'DISPID_SLPLangId', 'SpMemoryStream',
    'ISpeechRecognizer', 'SpeechInterference', 'SAFT12kHz16BitMono',
    'SAFT11kHz16BitStereo', 'ISpeechResourceLoader', 'SP_VISEME_5',
    'SVSFIsXML', 'STSF_AppData', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRRSetTextFeedback', 'ISpeechPhoneConverter',
    'ISpSerializeState', 'Speech_StreamPos_Asap', 'DISPID_SGRSTsItem',
    'SpeechMicTraining', 'STSF_LocalAppData',
    'DISPID_SGRInitialState', 'DISPID_SRCEBookmark',
    'SAFT24kHz16BitStereo', 'DISPID_SRSCurrentStreamNumber',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPBO_NONE',
    'SPPHRASEREPLACEMENT', 'SpeechLexiconType', 'SPEI_SOUND_END',
    'SpeechTokenValueCLSID', 'ISpeechAudioBufferInfo',
    'DISPID_SOTGetDescription',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpeechDiscardType',
    'SPCT_SUB_DICTATION', 'SAFTADPCM_8kHzStereo',
    'ISpeechLexiconWord', 'SpeechLoadOption', 'SAFT8kHz16BitStereo',
    ...
    'SAFTNoAssignedFormat', 'SPXRO_SML', 'DISPID_SRRAlternates',
    'SpeechRecoProfileProperties', 'DISPID_SPEAudioTimeOffset',
    'SPBO_TIME_UNITS', 'SPFILEMODE', 'DISPID_SVResume', 'SPPS_Noun',
    'SREAllEvents', 'DISPID_SPEDisplayText', 'SpLexicon',
    'DISPID_SpeechPhraseRules', 'SPSHT_OTHER', 'SDTAll',
    'SPRECORESULTTIMES', 'DISPID_SPIGetDisplayAttributes',
    'SpCompressedLexicon', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPRNumberOfElements', 'DISPID_SOTCId',
    'ISpeechObjectTokens', 'SpeechCategoryRecognizers',
    'SPDATAKEYLOCATION', 'SAFTGSM610_11kHzMono', 'SSFMCreate',
    'SRSActiveAlways', 'DISPID_SVESentenceBoundary',
    'SpeechRetainedAudioOptions', 'SPEI_PROPERTY_STRING_CHANGE',
    'SREStreamStart', 'SPSNoun', 'SpeechPropertyComplexResponseSpeed',
    'ISpNotifySource', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SDKSetStringValue', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRGCommit', 'DISPID_SRGIsPronounceable', 'SGDSActive',
    'DISPID_SRGetRecognizers', 'SPRST_NUM_STATES',
    'eLEXTYPE_RESERVED6', 'SWPUnknownWordPronounceable',
    'SP_VISEME_21', 'DISPID_SpeechGrammarRule',
    'DISPID_SpeechAudioFormat', 'SVSFDefault', 'SPWAVEFORMATTYPE',
    'DISPID_SVEStreamEnd', 'SGRSTTRule', 'DISPID_SRRTLength',
    'SPFM_CREATE_ALWAYS', 'SpeechCategoryPhoneConverters',
    'ISpPhoneticAlphabetSelection', 'SAFT8kHz8BitMono',
    'SVSFUnusedFlags', 'DISPID_SDKOpenKey', 'DISPID_SPAsCount',
    'ISpProperties', 'DISPID_SOTCGetDataKey', 'SpeechFormatType',
    'SINoSignal', 'UINT_PTR', 'SpeechAudioProperties',
    'DISPID_SGRsFindRule', 'DISPID_SVSInputWordPosition',
    'SPRS_ACTIVE', 'SRTReSent', 'SPWF_SRENGINE', 'DISPID_SOTId',
    'DISPID_SASFreeBufferSpace', 'ISpeechGrammarRuleStateTransitions',
    'SDTReplacement', 'DISPID_SRCCreateGrammar',
    'DISPID_SVIsUISupported', 'SPEI_PHONEME', 'SPDKL_CurrentUser',
    'DISPID_SGRSRule', 'ISpeechTextSelectionInformation',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SBSWrite', 'SVEPhoneme',
    'SAFTADPCM_44kHzMono', 'DISPID_SPRuleConfidence', 'SP_VISEME_13',
    'ISpStream', 'DISPID_SRGCmdLoadFromMemory',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechFileStream', 'SP_VISEME_0',
    'DISPID_SRGDictationSetState', 'DISPID_SRSetPropertyString',
    'DISPID_SRGCmdLoadFromObject', 'ISequentialStream',
    'DISPID_SPPFirstElement', 'DISPID_SBSSeek', 'DISPID_SRGReset',
    'SDTLexicalForm', 'SECFIgnoreKanaType', 'SpStreamFormatConverter',
    'SITooSlow', 'SVP_15', 'SpeechUserTraining', 'SINone',
    ...
    'SASPause', 'DISPID_SDKGetStringValue', 'SPEI_UNDEFINED',
    'SPFM_NUM_MODES', 'SP_VISEME_7', 'SP_VISEME_9',
    'DISPID_SpeechPhraseBuilder', 'SPSVerb', 'SAFTADPCM_22kHzMono',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFT12kHz8BitStereo',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SDKDeleteValue',
    'SPEI_END_SR_STREAM', 'eLEXTYPE_PRIVATE20', 'SPCT_SLEEP',
    'SPPS_RESERVED3', 'SpPhraseInfoBuilder', 'SPINTERFERENCE_TOOFAST',
    'SGRSTTWildcard', 'SITooFast', 'SAFT11kHz8BitMono',
    'ISpeechPhraseElements', 'SRESoundEnd', 'SAFTADPCM_8kHzMono',
    'SVPOver', 'Speech_Default_Weight', 'SP_VISEME_15', 'SVP_20',
    'SPEI_RESERVED1', 'DISPID_SOTsCount',
    ...
    'DISPID_SRGId', 'SPPS_Function', 'SPEI_END_INPUT_STREAM',
    'SP_VISEME_6', 'DISPID_SGRsCommitAndSave',
    'DISPID_SpeechPhraseProperty', 'DISPID_SBSFormat', 'SPSFunction',
    'SAFT24kHz8BitMono', 'ISpResourceManager',
    'SpeechRecognitionType', 'eLEXTYPE_RESERVED4',
    'DISPID_SpeechCustomStream', 'SWPUnknownWordUnpronounceable',
    'DISPID_SPAsItem', 'DISPID_SpeechVoice', 'SVP_21',
    ...
    'SpeechRecognizerState', 'SLOStatic',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPRDisplayAttributes',
    'SGPronounciation', 'SpMMAudioIn', 'STSF_CommonAppData',
    'SPRS_INACTIVE', 'IInternetSecurityMgrSite', 'SVP_19',
    'DISPID_SVSyncronousSpeakTimeout', 'SpeechGrammarTagWildcard',
    'SpVoice', 'DISPID_SPIGetText', 'DISPID_SRSClsidEngine', 'SVP_16',
    'SAFT11kHz16BitMono', 'SAFTGSM610_44kHzMono', 'ISpRecoGrammar',
    'SPFM_OPEN_READWRITE', 'DISPID_SRCVoice', 'DISPID_SPRuleChildren',
    'SGRSTTEpsilon', 'DISPID_SLPSymbolic', 'SFTInput', 'SVP_9',
    'SP_VISEME_8', 'DISPID_SGRs_NewEnum', 'SPRECOGNIZERSTATUS',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SLPs_NewEnum',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SPELexicalForm',
    'DISPID_SVSpeakCompleteEvent', 'SPLEXICONTYPE',
    'SVSFPurgeBeforeSpeak', 'DISPID_SGRName', 'DISPID_SRRSpeakAudio',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRRTOffsetFromStart', 'SVF_Stressed',
    'DISPID_SPRulesItem', 'DISPID_SRSNumberOfActiveRules',
    'SPBO_AHEAD', 'SpPhoneConverter', 'SPCT_COMMAND',
    'SpeechGrammarState', 'DISPID_SPPValue',
    'ISpeechObjectTokenCategory', 'SPAUDIOSTATE',
    'DISPID_SVEBookmark', 'DISPID_SRRRecoContext',
    'eLEXTYPE_RESERVED8', 'DISPID_SVEStreamStart',
    'DISPID_SRRSaveToMemory', 'SPPS_SuppressWord', 'SPBINARYGRAMMAR',
    'DISPID_SGRSTWeight', 'ISpeechPhraseElement',
    'DISPID_SOTCreateInstance', 'eLEXTYPE_PRIVATE18',
    'DISPID_SRCPause', 'SAFT32kHz8BitStereo', 'SPXMLRESULTOPTIONS',
    'SWPKnownWordPronounceable', 'DISPID_SRCCmdMaxAlternates',
    'eLEXTYPE_PRIVATE17', 'DISPID_SOTDataKey', 'SPPS_RESERVED1',
    'SPRULESTATE', 'SITooQuiet', 'SpeechAddRemoveWord',
    'DISPID_SPPNumberOfElements', 'SpMMAudioEnum',
    'DISPID_SRCEventInterests', 'SPLO_STATIC', 'DISPID_SBSRead',
    'DISPID_SGRSTNextState', 'DISPID_SPILanguageId',
    'DISPID_SPPChildren', 'ISpeechRecoResult2', 'DISPID_SDKDeleteKey',
    'SP_VISEME_12', 'SGDSInactive', 'SpeechAudioFormatType',
    'SpWaveFormatEx', 'SECFEmulateResult', 'SPGRAMMARSTATE',
    'SPAS_PAUSE', 'SVEWordBoundary', 'SWTAdded', 'DISPID_SPIElements',
    'SpResourceManager', 'DISPID_SPPsItem',
    'DISPID_SPAStartElementInResult', 'DISPID_SLWsItem',
    'SVSFNLPSpeakPunc', 'DISPID_SRCCreateResultFromMemory',
    'SPWF_INPUT', 'SREAudioLevel', 'SREStateChange',
    'SpeechRecoContextState', 'SAFT8kHz16BitMono',
    'SPDKL_LocalMachine', 'DISPID_SPRText', 'SPSHORTCUTTYPE',
    'SPFM_OPEN_READONLY', 'SPCONTEXTSTATE', 'SVF_None', 'SVP_13',
    'SPSERIALIZEDRESULT', 'DISPID_SOTsItem', 'SPSTREAMFORMATTYPE',
    'SPWT_LEXICAL', 'DISPID_SMSAMMHandle',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SpeechObjectTokens',
    'DISPID_SLWLangId', 'DISPID_SRCSetAdaptationData', 'tagSTATSTG',
    'SPEI_SR_PRIVATE', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPPS_Modifier', 'DISPID_SPEsCount', 'SPSHORTCUTPAIRLIST',
    'SVP_17', 'ISpShortcut', 'ISpeechLexiconPronunciations',
    'DISPID_SpeechGrammarRules', 'SPCS_DISABLED', 'ISpXMLRecoResult',
    'tagSPPROPERTYINFO', 'SpNotifyTranslator', 'SPEI_START_SR_STREAM',
    'DISPID_SASCurrentSeekPosition', 'SECFNoSpecialChars',
    'SPPS_Unknown', 'eLEXTYPE_PRIVATE16', 'DISPID_SWFEAvgBytesPerSec',
    'eLEXTYPE_PRIVATE2', 'DISPID_SABufferNotifySize',
    'DISPID_SASNonBlockingIO',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'STCRemoteServer',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPAUDIOOPTIONS',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SpeechPhraseAlternates',
    'SP_VISEME_20', 'DISPID_SDKGetBinaryValue', 'SRAORetainAudio',
    'ISpeechCustomStream', 'ISpEventSource', 'SVEBookmark',
    'eLEXTYPE_PRIVATE8', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SPPConfidence', 'DISPID_SRAudioInputStream',
    '_ISpeechVoiceEvents', 'ISpPhoneticAlphabetConverter',
    'ISpeechRecoResult', 'DISPID_SRRPhraseInfo',
    'ISpeechPhraseReplacements', 'ISpVoice', 'ISpeechLexicon',
    'SRTExtendableParse', 'SVSFPersistXML', 'SVP_5',
    'SpeechGrammarTagUnlimitedDictation', 'eLEXTYPE_PRIVATE13',
    'SPXRO_Alternates_SML', 'SpeechVoicePriority',
    'SpeechPartOfSpeech', 'ISpPhraseAlt', 'DISPID_SRStatus',
    'SECNormalConfidence', 'SREFalseRecognition',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPEsItem',
    'DISPID_SFSClose', 'SVSFParseSapi', 'DISPID_SRCESoundEnd',
    'SAFT16kHz8BitMono', 'DISPID_SRCERecognizerStateChange',
    'SPWT_DISPLAY', 'DISPID_SRCEHypothesis', 'DISPID_SRRTTickCount',
    'SPAO_NONE', 'DISPID_SRGState', 'SAFTCCITT_ALaw_44kHzMono',
    'SREHypothesis', 'SPINTERFERENCE_NONE',
    'SpeechEmulationCompareFlags', 'DISPID_SOTs_NewEnum',
    'SVSFParseMask', 'SPEVENT', 'DISPID_SRCRetainedAudioFormat',
    'SPFM_CREATE', 'SGDSActiveWithAutoPause',
    'DISPID_SVAlertBoundary', 'SDKLDefaultLocation',
    'DISPID_SDKEnumKeys', 'DISPID_SGRId', 'LONG_PTR',
    'DISPID_SVWaitUntilDone', 'DISPID_SRCEPhraseStart',
    'ISpRecoGrammar2', 'DISPID_SRCEPropertyStringChange',
    'STSF_FlagCreate', 'DISPID_SOTCDefault', 'SPPS_LMA',
    'SVEAudioLevel', 'SpeechEngineProperties', 'SVEEndInputStream',
    'eLEXTYPE_PRIVATE5', 'DISPID_SPIProperties',
    'DISPID_SDKCreateKey', 'DISPID_SOTRemove',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRCResume',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SPIStartTime', 'DISPID_SVSLastStreamNumberQueued',
    'SPSHT_EMAIL', 'SVP_4', 'DISPID_SGRSTransitions',
    'DISPID_SPIEnginePrivateData', 'SDA_One_Trailing_Space',
    'ISpeechVoice', 'SASRun', 'SVF_Emphasis', 'ISpeechRecoGrammar',
    'DISPID_SPISaveToMemory', 'SGDisplay', 'SAFTADPCM_22kHzStereo',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpStreamFormat', 'SPSNotOverriden',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRGetFormat', 'SRARoot',
    'DISPID_SpeechLexiconPronunciation', 'SPEI_RESERVED3',
    'SPWT_PRONUNCIATION', 'SPAS_RUN', 'DISPID_SVSRunningState',
    'SP_VISEME_14', '_SPAUDIOSTATE', 'ISpPhrase',
    ...
    'DISPID_SWFESamplesPerSec', 'SPEI_INTERFERENCE',
    'ISpGrammarBuilder', 'DISPID_SGRsDynamic', 'SpInProcRecoContext',
    'SpeechTokenKeyUI', 'SPSMF_UPS', 'ISpeechDataKey',
    'SGRSTTDictation', 'SRATopLevel', 'ISpObjectWithToken',
    'SPEI_TTS_BOOKMARK', 'SPWORDPRONUNCIATION', 'SVSFIsFilename',
    'ISpNotifySink', 'SVP_6', 'DISPID_SVEAudioLevel', 'SGSEnabled',
    'DISPID_SPRsItem', 'DISPID_SFSOpen', 'SPPS_Noncontent',
    'SPSHORTCUTPAIR', 'ISpeechPhraseInfoBuilder',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SGRAddState',
    'DISPID_SPPEngineConfidence', 'DISPID_SRCERecognition',
    'SASClosed', 'ISpEventSink', 'eLEXTYPE_LETTERTOSOUND',
    'SAFT12kHz8BitMono', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SGRsItem', 'SPAR_High', 'SPAS_STOP', 'eLEXTYPE_PRIVATE7',
    'DISPID_SLRemovePronunciation', 'SpeechPropertyAdaptationOn',
    'SP_VISEME_2', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SVGetAudioInputs', 'SPEI_RECOGNITION', 'ISpMMSysAudio',
    'SDTProperty', 'SPPARTOFSPEECH', 'SAFT32kHz8BitMono',
    'SECLowConfidence', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SPRuleFirstElement', 'DISPID_SPIRule',
    'DISPID_SPRuleNumberOfElements', 'STCInprocHandler',
    'SECFIgnoreWidth', 'SPVOICESTATUS', 'SpeechGrammarTagDictation',
    'ISpDataKey', 'SpFileStream', 'DISPID_SpeechVoiceStatus',
    'DISPID_SGRSTPropertyName', 'DISPID_SOTIsUISupported',
    'SpSharedRecognizer', 'DISPID_SVRate', 'SAFT44kHz16BitStereo',
    'DISPID_SPCLangId', 'SAFT11kHz8BitStereo', 'DISPID_SLWType',
    'eLEXTYPE_PRIVATE1', 'DISPID_SDKEnumValues',
    'ISpeechPhraseProperties', 'ISpeechXMLRecoResult',
    ...
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SVSkip', 'DISPID_SRRAudio',
    'ISpeechObjectToken', 'SAFTGSM610_22kHzMono', 'SP_VISEME_1',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SLWWord',
    'SAFT16kHz16BitMono', 'DISPID_SRCreateRecoContext',
    'DISPID_SWFEExtraData', '_RemotableHandle',
    'SPEI_RECO_OTHER_CONTEXT', 'SDTRule',
    'DISPID_SLGetPronunciations', 'SDKLCurrentUser', 'SVEPrivate',
    'SAFTADPCM_44kHzStereo', 'DISPID_SOTSetId', 'SVSFIsNotXML',
    'SPGS_DISABLED', 'DISPID_SpeechRecognizer', 'SpInprocRecognizer',
    'SREPhraseStart', 'ISpeechAudioFormat', 'SPPS_NotOverriden',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRProfile',
    'SAFTADPCM_11kHzMono', 'eWORDTYPE_DELETED', 'SPSERIALIZEDPHRASE',
    'SLTApp', 'DISPID_SpeechFileStream', 'SPLO_DYNAMIC',
    'SPVPRI_ALERT', 'WAVEFORMATEX', 'SVP_1', 'SPPS_Verb',
    'SpeechAudioFormatGUIDText', 'SREStreamEnd', 'SDKLLocalMachine',
    'SpUnCompressedLexicon', 'SpeechWordPronounceable',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPIEngineId',
    'ISpeechVoiceStatus', 'DISPID_SpeechMMSysAudio',
    'ISpeechPhraseInfo', 'SAFTCCITT_ALaw_11kHzMono',
    'SPPHRASEELEMENT', 'DISPID_SLGetGenerationChange', 'SRSActive',
    'DISPID_SRGSetTextSelection', 'SPSUnknown', 'SPRST_ACTIVE',
    'SpSharedRecoContext', 'eLEXTYPE_RESERVED7', 'DISPID_SRGRules',
    'SRSInactiveWithPurge', 'DISPID_SRCEAdaptation',
    'DISPID_SDKGetlongValue', 'SpeechVisemeFeature',
    'SAFTNonStandardFormat', 'SVEViseme', 'DISPIDSPRG',
    'ISpeechPhraseReplacement', 'DISPID_SLPType',
    'DISPID_SGRSAddWordTransition', 'SPAUDIOBUFFERINFO',
    'DISPID_SGRSTPropertyValue', 'ISpRecoCategory',
    'eLEXTYPE_PRIVATE6', 'SAFT44kHz8BitStereo', 'DISPID_SGRsAdd',
    'DISPID_SRIsUISupported', 'DISPID_SOTCategory', 'ISpLexicon',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPDKL_DefaultLocation', 'IStream',
    'DISPID_SLPsItem', 'SPEI_VISEME', 'IInternetSecurityManager',
    'SGDSActiveUserDelimited', 'SRAONone',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRAudioInput',
    'DISPID_SLPPhoneIds', 'DISPID_SRSAudioStatus',
    'SpeechAudioVolume', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SRTAutopause', 'SBONone', 'DISPID_SpeechDataKey', 'SLTUser',
    'SPGS_ENABLED', 'eLEXTYPE_PRIVATE4',
    'DISPID_SPEAudioStreamOffset', 'SPSInterjection',
    'DISPID_SASState', 'SPINTERFERENCE', 'DISPID_SPIGrammarId',
    'SGLexical', 'DISPID_SPAs_NewEnum', 'SP_VISEME_18', 'SGSDisabled',
    'SREPropertyStringChange', 'DISPID_SPPs_NewEnum',
    'SPINTERFERENCE_NOISE', 'SP_VISEME_3', 'DISPID_SVEEnginePrivate',
    'DISPID_SRCBookmark', 'ISpAudio', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SAEventHandle', 'DISPID_SPERequiredConfidence',
    'SAFT16kHz8BitStereo', 'DISPID_SpeechRecoResult',
    'DISPID_SpeechPhoneConverter', 'SVEVoiceChange',
    'SpeechAllElements', 'DISPID_SVEventInterests', 'ISpRecoContext',
    'ISpeechMMSysAudio', 'SpeechDataKeyLocation', 'DISPID_SLGetWords',
    'DISPIDSPTSI', 'SPEVENTSOURCEINFO', 'DISPID_SPRFirstElement',
    'SpMMAudioOut', 'DISPID_SVEWord', 'DISPID_SRCRecognizer',
    'SP_VISEME_11', 'ISpeechPhraseProperty', 'ISpPhoneConverter',
    'SPSMF_SAPI_PROPERTIES', 'SPINTERFERENCE_NOSIGNAL', 'SPWORDLIST',
    'DISPID_SRCESoundStart', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SGRsCount', 'SECFDefault', 'ISpRecoResult',
    'DISPID_SPCPhoneToId', 'SPEI_TTS_AUDIO_LEVEL', 'SAFTText',
    'STCAll', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRGCmdLoadFromFile', 'SpCustomStream',
    'SAFT24kHz16BitMono', 'SVP_2', 'DISPID_SpeechAudio',
    'ISpRecognizer3', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SPAPhraseInfo', 'ISpeechGrammarRuleStateTransition',
    'STCLocalServer', 'DISPID_SPRuleEngineConfidence',
    'SPEI_SOUND_START', 'DISPID_SGRSTText', 'SPEI_START_INPUT_STREAM',
    'SPEI_RESERVED6', 'SASStop', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SPRuleParent', 'ISpeechGrammarRuleState',
    'ISpRecoContext2', 'SPWORD', 'DISPID_SGRSTPropertyId',
    'DISPID_SpeechXMLRecoResult', 'ISpeechPhraseAlternates',
    'SRCS_Enabled', 'DISPID_SPARecoResult', 'IEnumSpObjectTokens',
    'DISPID_SGRAddResource', 'SPSLMA', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPWORDTYPE', 'SpeechEngineConfidence', 'SVP_8',
    'DISPID_SpeechLexiconProns', 'SRESoundStart', 'SPEI_ADAPTATION',
    'SPBO_PAUSE', 'SPDKL_CurrentConfig', 'DISPID_SRGDictationUnload',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFT48kHz16BitMono',
    'eLEXTYPE_MORPHOLOGY', 'SPCS_ENABLED', 'DISPID_SPPParent',
    'eLEXTYPE_PRIVATE12', 'DISPID_SMSADeviceId', 'SRSEDone',
    'SRAInterpreter', 'SRSEIsSpeaking', 'DISPID_SRCEEndStream',
    'SAFTCCITT_uLaw_11kHzStereo', 'SVP_0', 'DISPID_SRCERequestUI',
    'SpeechRuleAttributes', 'DISPID_SpeechPhraseInfo',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFT22kHz16BitMono',
    'DISPID_SLPsCount', 'DISPID_SRRTimes', 'DISPID_SVVolume',
    'SPVPRI_OVER', 'SPEI_TTS_PRIVATE', 'SRERecognition',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SVSLastBookmark',
    'DISPID_SOTDisplayUI', 'DISPID_SVSVisemeId',
    'SVSFParseAutodetect', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRCEEnginePrivate', 'eWORDTYPE_ADDED',
    'DISPID_SPEActualConfidence', 'SVP_14',
    'DISPIDSPTSI_SelectionLength', 'SSFMOpenForRead', 'SLODynamic',
    'SPSHT_Unknown', 'eLEXTYPE_RESERVED10',
    'DISPID_SPEEngineConfidence', 'DISPID_SCSBaseStream',
    'SPEI_PHRASE_START', 'DISPID_SPANumberOfElementsInResult',
    ...
    'SpeechRecoEvents', 'DISPID_SPEs_NewEnum', 'SPCT_DICTATION',
    'ISpRecognizer2', 'SpeechCategoryAudioOut', 'SpShortcut',
    'SRAExport', 'SP_VISEME_10', 'SPSSuppressWord',
    'SAFT48kHz8BitStereo', 'DISPID_SRGCmdSetRuleState',
    'SREInterference', 'DISPID_SAFGuid', 'DISPID_SVEVoiceChange',
    'SITooLoud', 'ISpeechLexiconWords', 'ISpeechPhraseRule',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SABIBufferSize',
    'SPRECOCONTEXTSTATUS', 'DISPID_SpeechLexiconWord',
    'SpeechDisplayAttributes', 'Speech_Max_Pron_Length',
    'SGRSTTTextBuffer', 'SRSInactive', 'DISPID_SVPause',
    'ISpeechGrammarRule', 'SPPROPERTYINFO', 'SDTAlternates',
    'SPPS_RESERVED4', 'SpeechStreamSeekPositionType',
    'DISPID_SVGetProfiles', 'DISPID_SpeechPhraseElement',
    'SpAudioFormat', 'ISpeechRecoResultTimes', 'SDKLCurrentConfig',
    'DISPID_SPEAudioSizeTime', 'SPWORDPRONUNCIATIONLIST',
    'SPEVENTENUM', 'DISPID_SVPriority',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SVGetVoices',
    'DISPID_SGRsCommit', 'SpObjectToken', 'SPEI_WORD_BOUNDARY',
    'SPAO_RETAIN_AUDIO', 'DISPID_SAStatus', 'SINoise',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SpeechLexiconWords',
    'SPPHRASERULE', 'DISPID_SABIEventBias', 'SPGRAMMARWORDTYPE',
    'SpeechTokenIdUserLexicon', 'DISPID_SWFEChannels',
    'SRADefaultToActive', 'SVPNormal', 'eLEXTYPE_USER',
    'SpeechCategoryVoices', 'DISPID_SPRules_NewEnum', 'SREPrivate',
    'SFTSREngine', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SAVolume', 'DISPID_SPACommit', 'DISPID_SPRulesCount',
    'eLEXTYPE_PRIVATE10', 'DISPID_SWFEFormatTag', 'SPPHRASE',
    'ISpRecognizer', 'SpeechVoiceCategoryTTSRate',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpeechPhraseRules',
    'DISPID_SGRSTsCount', 'SPEI_HYPOTHESIS',
    'DISPID_SpeechPhraseRule', 'SGSExclusive',
    'DISPID_SRGRecoContext', 'SpeechRunState',
    'SpeechBookmarkOptions', 'SREPropertyNumChange',
    'SAFT24kHz8BitStereo', 'DISPID_SWFEBlockAlign',
    'DISPID_SMSALineId', 'SREAdaptation',
    'DISPID_SVSInputSentenceLength', 'SpStream', 'DISPID_SASetState',
    'DISPID_SMSGetData', 'SP_VISEME_16', 'SDTPronunciation',
    'tagSPTEXTSELECTIONINFO', 'SP_VISEME_17',
    'DISPID_SVSLastBookmarkId',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpNullPhoneConverter',
    'DISPID_SVEViseme', 'SSTTDictation', 'DISPID_SVAudioOutputStream',
    ...
    'DISPID_SPRsCount', 'SPEI_MIN_SR', 'DISPID_SRSSupportedLanguages',
    'DISPID_SDKSetLongValue', 'SVSFVoiceMask',
    'SpeechTokenKeyAttributes', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SOTCSetId', 'DISPID_SLWPronunciations', 'SPRECOSTATE',
    'DISPID_SpeechLexicon', '_ISpeechRecoContextEvents',
    'DISPID_SGRClear', 'SAFT22kHz16BitStereo', 'SDTDisplayText',
    'DISPID_SLAddPronunciation', 'DISPID_SRCState', 'SGRSTTWord',
    'SAFTGSM610_8kHzMono', 'ISpObjectToken',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SPEI_SENTENCE_BOUNDARY', 'SAFT32kHz16BitMono',
    'SpeechAudioState', 'DISPID_SRRecognizer',
    'ISpeechRecognizerStatus', 'DISPID_SRSetPropertyNumber',
    'SPAR_Unknown', 'SP_VISEME_4', 'ISpeechWaveFormatEx',
    'SRERecoOtherContext', 'SpeechGrammarRuleStateTransitionType',
    'ISpeechRecoResultDispatch', 'SVSFlagsAsync',
    'SAFT16kHz16BitStereo', 'DISPID_SRIsShared', 'SpeechVoiceEvents',
    'SpeechPropertyResourceUsage', 'SPVPRIORITY', 'DISPID_SGRSTRule',
    'SAFT48kHz16BitStereo', 'DISPID_SADefaultFormat',
    'SAFT22kHz8BitStereo', 'SVSFParseSsml', 'SPTEXTSELECTIONINFO',
    'SAFT22kHz8BitMono', 'ISpeechBaseStream'
]

_check_version('1.2.1', 1700023953.863497)
